...
% layers, architecture being a n x 1 vector of layer sizes e.g. [784 100 10]
    ...
    nn.scaling_learningRate             = 1;            %  Scaling fact
    nn.weightPenaltyL2                  = 0;            %  L2 regularizationor for the learning rate (each epoch)
    nn.nonSparsityPenalty               = 0;            %  Non sparsity penalty 非稀疏惩罚
    nn.sparsityTarget                   = 0;         %  Sparsity target 系数目标
